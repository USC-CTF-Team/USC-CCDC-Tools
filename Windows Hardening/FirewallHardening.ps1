...
New-NetFirewallRule -DisplayName "FTP" -LocalPort 20-21 -Protocol TCP -Action Block -Enabled True -Direction Inbound
New-NetFirewallRule -DisplayName "Telnet" -LocalPort 23 -Protocol TCP -Action Block -Enabled True -Direction Inbound
